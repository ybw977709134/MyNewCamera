 ...
 * 备注：
 */
public class WifiNewNetSecondAcitivity extends BaseActivity implements View.OnClickListener {
    ...
    setContentView(R.layout.layout_wifi_main);
        initView();
    }
    ...
    private void getWiFiNumberforQr() {
        ...
        if (name.length() > 0) {
            ...
            Intent qrIntent = new Intent(WifiNewNetSecondAcitivity.this,CreateQrCodeActivity.class);
