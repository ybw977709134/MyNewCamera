...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	 ...
	 * while refreshing.
	 * 
	 * @param  if the widget has disabled scrolling while refreshing
	 */
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (a.hasValue(R.styleable.PullToRefresh_moremode)) {
			mode = a.getInteger(R.styleable.PullToRefresh_moremode,
